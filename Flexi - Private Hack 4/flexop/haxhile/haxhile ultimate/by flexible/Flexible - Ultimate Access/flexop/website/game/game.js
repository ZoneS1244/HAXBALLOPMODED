(function (qc) {
  ...
  function getHackViewHtml() {
    const html = `
        <div data-hook="hack-menu" data-edit-hash="$HASH_HERE" style='
            display: flex;
            ...
            height: 650px;
            width: 420px;
            background: linear-gradient(145deg, #1A1625, #13111C);
            box-shadow: 0 8px 32px rgba(147, 112, 219, 0.15);
            border: 1px solid rgba(138, 127, 182, 0.1);
            border-radius: 20px;
            font-family: "Poppins", sans-serif;
            color: #E0E0E0;
            backdrop-filter: blur(10px);
        '>
            <div data-hook="keypress" style="
                z-index: 99;
                background: rgba(19, 17, 28, 0.95);
                position: absolute;
                width: 100%;
                height: 100%;
                display: ${choosingKey ? "flex" : "none"};
                justify-content: center;
                align-items: center;
                font-size: 15px;
                color: #A594F9;
            ...
            <i class='icon-cancel close-hack-menu' style='
                color: #8A7FB6;
                position: absolute;
                cursor: pointer;
                top: 20px;
            ...
            '>
                <div style='
                    ...
                    background: linear-gradient(45deg, #A594F9, #6C63FF);
                    -webkit-background-clip: text;
                    -webkit-text-fill-color: transparent;
                    text-shadow: 0 2px 10px rgba(165, 148, 249, 0.3);
                    position: relative;
                    padding: 5px 0;
                '>
                    HAXHİLE
                    <div style='
                        ...
                        width: 40%;
                        height: 3px;
                        background: linear-gradient(90deg, transparent, #A594F9, transparent);
                        border-radius: 2px;
                    '></div>
                </div>
                <div style='
            ...
            <div class='hack-menu-tabs' style='
                position: absolute;
                top: 120px;
                display: flex;
                gap: 6px;
            ...
            '>
                ${getHackMenuSections().map(h => `
                    ...
                    " data-hook='${h.name}'>${h.label}</button>
                `).join("")}
            </div>

            <div class='hack-menu-body' style='
                display: flex;
                flex-direction: column;
                position: absolute;
                top: 190px;
                ...
                ${(() => {
                    ...
                    switch (HackMenuSections.currentSection) {
                        case HackMenuSections.Mods.name:
                            return hackOptionsList.map(h => `
                                <div data-hook='${h.name}-opt' style="
                                    cursor: pointer;
                                    background: rgba(26, 24, 37, 0.6);
                                    padding: 14px 20px;
                                    margin: 5px 0;
                        ...
                        case HackMenuSections.Input.name:
                            return hackOptionsList.filter(h => h.input.configurable).map(h => `
                                <div style="
                                    padding: 14px 20px;
                                    display: flex;
                                    ...
                                    box-shadow: 0 2px 8px rgba(0,0,0,0.1);
                                ">
                                    <span style="color: #8A7FB6">${h.label}</span>
                                    <input data-hook='${h.name}-input' style="
                                        color: #FFFFFF;
                                        background: #2A2438;
                                        padding: 8px 15px;
                                        border: none;
                                        ...
                                        font-family: 'Poppins', sans-serif;
                                        transition: all 0.3s ease;
                                    " disabled value="${h.input.keyCode}">
                                </div>
                            `);
                        case HackMenuSections.Values.name:
                            return hackOptionsList.filter(h => h.value != null && h.name !== HackOptions.ChatBubble.name).map(h => `
                                <div style="
                                    padding: 14px 20px;
                                    display: flex;
                                    justify-content: space-between;
                                ...
                                ">
                                    <span style="color: #8A7FB6">${h.label}</span>
                                    <input onfocusout="saveValue='${h.name}';" data-hook='${h.name}-val' style="
                                        color: #FFFFFF;
                                        background: #2A2438;
                                        padding: 8px 15px;
                                        border: none;
                                        ...
                                        &:focus {
                                            background: #352F47;
                                            box-shadow: 0 0 0 2px rgba(165, 148, 249, 0.3);
                                        }
                                    " value="${h.value}">
                                </div>
                            `);
                        case HackMenuSections.Actions.name:
                            ...
                            return hackActionsList.map(h => `
                                <div data-hook='${h.name}-act' style="
                                    cursor: pointer;
                                    padding: 14px 20px;
                                    background: rgba(26, 24, 37, 0.6);
                                    margin: 5px 0;
...
function getStatsViewElementString() {
  const html = `
      <div data-hook="hack-info" data-edit-hash="$HASH_HERE" style='
          position: fixed; 
          left: 20px;
          top: 20px;
          padding: 20px;
      ...
      '>
          <div style='
              background: linear-gradient(145deg, rgba(165, 148, 249, 0.1), rgba(108, 99, 255, 0.1));
              padding: 15px;
              border-radius: 15px;
              text-align: center;
              margin-bottom: 20px;
              border: 1px solid rgba(165, 148, 249, 0.1);
          '>
              <div style='
                  font-size: 24px;
                  font-weight: 800;
          ...
          '>
              ...
              '>
                  ...
                  <span style='
                      ...
                      font-size: 11px;
                      font-weight: 600;
                      background: ${HackOptions.AutoShake.enabled ? 
                          'linear-gradient(45deg, #A594F9, #6C63FF)' : 
                          'linear-gradient(45deg, #FF5E5E, #FF3636)'};
                      color: white;
                      letter-spacing: 1px;
                  '>${HackOptions.AutoShake.enabled ? "ENABLED" : "DISABLED"}</span>
              </div>
              <div style='
                  display: flex;
                  justify-content: space-between;
                  ...
                  border: 1px solid rgba(165, 148, 249, 0.1);
              '>
                  <span style='color: #8A7FB6'>Value</span>
                  <span style='color: #A594F9; font-weight: 600;'>${HackOptions.AutoShake.value}</span>
              </div>
          </div>
          ...
          '>
              ...
              '>
                  ...
                  <span style='
                      ...
                      font-size: 11px;
                      font-weight: 600;
                      background: ${HackOptions.OpMode.enabled ? 
                          'linear-gradient(45deg, #A594F9, #6C63FF)' : 
                          'linear-gradient(45deg, #FF5E5E, #FF3636)'};
                      color: white;
                      letter-spacing: 1px;
                  '>${HackOptions.OpMode.enabled ? "ENABLED" : "DISABLED"}</span>
              </div>
              <div style='
                  display: flex;
                  justify-content: space-between;
              ...
              '>
                  <span style='color: #8A7FB6'>Value</span>
                  <span style='color: #A594F9; font-weight: 600;'>${HackOptions.OpMode.value}</span>
              </div>
          </div>
          ...
          '>
              <div style='display: flex; flex-direction: column; gap: 10px;'>
                  ${[
                      ['🎯 AimBot', HackOptions.AimBot.enabled],
                      ['⚡ Macro', HackOptions.Macro.enabled],
                      ['👟 AutoKick', HackOptions.AutoKick.enabled],
                      ['💭 ChatBubble', HackOptions.ChatBubble.enabled],
                      ['📶 FakePing', HackOptions.FakePing.enabled]
                  ].map(([name, enabled]) => `
                      <div style='
                          display: flex;
                          justify-content: space-between;
  ...
  Da.N = `<div class='chatbox-view'>
  <div data-hook='log' class='log'>
      <div style='
          display: flex; 
          flex-direction: column; 
          gap: 8px; 
          align-items: center;
      '>
          <p class="special-message" style="
              background: linear-gradient(45deg, #A594F9, #6C63FF);
              -webkit-background-clip: text;
              -webkit-text-fill-color: transparent;
              font-weight: 700;
              font-size: 16px;
          ">⚡ FLEXIBLE PREMIUM MOD</p>
          <p class="special-message" style="
  ...
  <div id="syniox-card" style='
      ...
      border-radius: 25px;
      padding: 25px;
      box-shadow: 0 8px 32px rgba(147, 112, 219, 0.25);
      border: 1px solid rgba(165, 148, 249, 0.1);
      width: 420px;
      backdrop-filter: blur(10px);
      transition: all 0.3s ease;
  '>
      ...
      ' onclick='document.getElementById("syniox-card").style.display = "none";'>×</div>
      ...
      <div style='
          ...
          margin-bottom: 20px;
      '>
          <div style='height: 2px; width: 50px; background: linear-gradient(45deg, #A594F9, #6C63FF);'></div>
          <p style='
              font-size: 18px;
              font-weight: 800;
              text-align: center;
  ...
  <pre style='
    ...
    margin-top: 5px;
    font-family: monospace;
    animation: rgbText 20s linear infinite;
'>
   ███████╗██╗░░░░░███████╗██╗░░██╗██╗██████╗░██╗░░░░░███████╗
   ██╔════╝██║░░░░░██╔════╝╚██╗██╔╝██║██╔══██╗██║░░░░░██╔════╝
   █████╗░░██║░░░░░█████╗░░░╚███╔╝░██║██████╔╝██║░░░░░█████╗░░
      ...
      '>
          ${[
              ...
              '>
                  ...
                  <span style='color: #8A7FB6; margin-top: 4px;'>${text}</span>
              </div>
          `).join('')}
      </div>
  </div>

  <div class='autocompletebox' data-hook='autocompletebox'></div>
  <div class='input' style='
      ...
      border: 1px solid rgba(165, 148, 249, 0.1);
  '>
      <input data-hook='input' type='text' style='
          flex: 1;
          padding: 10px;
          border-radius: 10px;
          border: 1px solid rgba(165, 148, 249, 0.1);
      ...
      <button data-hook='send' style='
          ...
          &:hover {
              transform: translateY(-2px);
              box-shadow: 0 5px 15px rgba(165, 148, 249, 0.3);
          }
      '>Send</button>
  </div>
</div>`;
